...
export default function Testimonials() {
  return (
    <section
      className="relative bg-fixed bg-center bg-cover bg-no-repeat flex py-10 md:py-16 lg:py-24 items-center justify-center"
      style={{
        backgroundImage: "url('images/portrait-successful-young-students-showing-thumbs-up.jpg')",
      }}
    >
      {/* Overlay */}
      ...
      <div className="relative z-10 text-center text-white max-w-2xl px-6">
        <h2 className="ttext-3xl md:text-4xl font-bold mb-4">What Our <span className="text-secondary">Students Say's</span></h2>
        <p className="text-lg text-popover-foreground dark:text-popover-foreground mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white text-black rounded-xl p-6 shadow-lg">
            ⭐⭐⭐⭐⭐  
            <p>
              Content is king, but design makes it shine beautifully.
            </p>
          </div>
        </div>
      </div>
