...
const testimonials = [
   ...
   },
   {
      ...
      rating: 5,
      description: "Managing students and teachers has never been easier. eduSmart is a lifesaver for our administration team.",
   },
   {
      id: 3,
      name: "Rafiq Ahmed",
...
function Testimonials() {
   ...
   return (
      <div data-aos="fade-up" className="slider-container px-4 md:px-6 lg:px-12 py-12 md:py-20 lg:py-28">
