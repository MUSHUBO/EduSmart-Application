    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-10 md:gap-14 min-h-screen px-4 my-4">
      ...
      <div className="relative bg-secondary p-4 flex-shrink-0">
        ...
        <div className="absolute inset-0 border border-foreground">
          {/* Corner circles */}
          <div className="absolute -top-2 -left-2 w-3 h-3 md:w-4 md:h-4 bg-white border border-foreground rounded-full"></div>
          <div className="absolute -top-2 -right-2 w-3 h-3 md:w-4 md:h-4 bg-white border border-foreground rounded-full"></div>
          <div className="absolute -bottom-2 -left-2 w-3 h-3 md:w-4 md:h-4 bg-white border border-foreground rounded-full"></div>
          <div className="absolute -bottom-2 -right-2 w-3 h-3 md:w-4 md:h-4 bg-white border border-foreground rounded-full"></div>
        </div>
      ...
      <div className="font-medium text-center md:text-left">
        <h5 className="text-foreground text-lg sm:text-xl mb-1 underline underline-offset-8">
          Welcome to EduSmart Application
        </h5>

        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-foreground mb-4 md:mb-8">
