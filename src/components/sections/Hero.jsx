...
const Hero = () => {
  return (
    <div>
      ...
      {/* FAQ Section added by Rabiul */}
      <div className="px-4 my-12">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-popover dark:text-popover mb-8 underline underline-offset-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 max-w-5xl mx-auto">
          ...
          <div className="relative bg-secondary p-6">
            <div className="absolute inset-0 border border-foreground">
              <div className="absolute -top-2 -left-2 w-3 h-3 bg-popover border border-foreground rounded-full"></div>
              <div className="absolute -top-2 -right-2 w-3 h-3 bg-popover border border-foreground rounded-full"></div>
              <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-popover border border-foreground rounded-full"></div>
              <div className="absolute -bottom-2 -right-2 w-3 h-3 bg-popover border border-foreground rounded-full"></div>
            </div>
            <h3 className="relative z-10 font-semibold text-lg text-popover dark:text-popover mb-2">
              What age group do you accept?
            </h3>
            <p className="relative z-10 text-sm text-popover-foreground dark:text-popover-foreground">
              We welcome children from ages 3 to 6, providing age-appropriate
              learning experiences tailored to each stage of early childhood.
            </p>
          </div>
          ...
          <div className="relative bg-secondary p-6">
            ...
            <p className="relative z-10 text-sm text-popover-foreground dark:text-popover-foreground">
              Each class is kept small (around 12–15 students) to ensure
              personalized attention and meaningful interaction with teachers.
            </p>
          </div>
          ...
          <div className="relative bg-secondary p-6">
            ...
            <p className="relative z-10 text-sm text-popover-foreground dark:text-popover-foreground">
              Yes, we provide healthy and balanced snacks and meals, taking into
              account dietary restrictions and preferences.
            </p>
          </div>
          ...
          <div className="relative bg-secondary p-6">
            ...
            <p className="relative z-10 text-sm text-popover-foreground dark:text-popover-foreground">
              Enrollment is simple! Contact our admissions office, schedule a
              visit, and we’ll guide you through the application process.
            </p>
          </div>
        </div>
      </div>
