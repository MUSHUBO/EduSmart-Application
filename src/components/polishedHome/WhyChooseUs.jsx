    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
        ...
        >
          ...
          >
            We Are Expert &{" "}
            <span className="text-orange-400">Do Our Best</span> For Your Goal
          </motion.h2>
          ...
          >
            ...
            readable content of a page when many desktop and web page editors
        ...
        >
          <Image
            ...
            width={500}
            height={500}
            className="border-primary border-8 rounded-b-full rounded-tl-full object-cover"
          />
        </motion.div>
      </div>
    </section>
