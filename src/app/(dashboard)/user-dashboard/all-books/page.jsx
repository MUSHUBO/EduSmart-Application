...
export default function Library() {
  ...
  useEffect(() => {
    axios
      ...
      .finally(() => {
        setLoading(false); // ✅ stop loading after data is fetched (success or error)
      });
  }, []);
    ...
    <div className="px-2 md:px-2 lg:px-2 py-6 md:py-6 lg:py-6">
      <div className="text-center max-w-3xl mx-auto px-6">
        ...
        <p className="text-lg text-popover-foreground dark:text-popover-foreground mb-10 mt-3">
          Explore our curated selection of books, from classics to modern masterpieces. 
          Browse by top rated, most commented, or new arrivals.
        </p>
      </div>
      ...
      {booksData.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {booksData.map((book) => (
            <div
              key={book._id}
              className="bg-muted dark:bg-muted rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300"
            >
              <img
                src={book.photoUrl}
                alt={book.name}
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-popover-foreground dark:text-popover-foreground text-sm">
        ...
        <div className="text-center text-popover-foreground dark:text-popover-foreground">
          No books found.
        </div>
      )}
    </div>
